                ...
                <div className="mx-auto max-w-7xl bg-white border-x border-black-300 px-4 sm:px-8 py-10">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex gap-6 text-sm font-bold uppercase text-black-900">
                            <Link href="#" className="hover:underline transition-all">Despre</Link>
                            <Link href="#" className="hover:underline transition-all">Termeni</Link>
                            <Link href="#" className="hover:underline transition-all">Confidențialitate</Link>

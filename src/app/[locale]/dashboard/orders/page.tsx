            ...
            <div className="bg-white border border-mercury-200 overflow-hidden">
                <div className="overflow-x-auto">
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-mercury-200 bg-mercury-50/30">
                        ...
                        <tbody className="divide-y divide-mercury-200">
                            {orders.map((order) => (
                                <tr
                                    key={order.id}
                                    className="hover:bg-mercury-50/30 transition-colors cursor-pointer"
                                >
                                    <td className="px-5 py-4 font-data text-sm text-mercury-900">
                                        {order.orderNumber}
                                    </td>
                                    <td className="px-5 py-4">
                                        <div className="flex items-center gap-2.5">
                                            ...
                                            />
                                            <div>
                                                <p className="text-sm font-medium text-mercury-900">
                                                    {order.buyer.name}
                                                </p>
                                    ...
                                    <td className="px-5 py-4">
                                        <p className="text-sm text-mercury-900 line-clamp-1">
                                            {order.items
                                    ...
                                    <td className="px-5 py-4 text-sm text-mercury-500 whitespace-nowrap">
                                        {formatDate(order.createdAt)}
                                    </td>
                                    <td className="px-5 py-4 text-sm text-mercury-900 capitalize">
                                        {logisticsLabels[order.logistics] ||
                                            order.logistics}
                                    </td>
                                    <td className="px-5 py-4">
                                        <span
                                    ...
                                    <td className="px-5 py-4 text-right font-data text-sm font-medium text-mercury-900">

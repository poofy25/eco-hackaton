...
export default function Sidebar() {
    ...
    return (
        <aside className="hidden lg:flex w-64 shrink-0 flex-col bg-forest rounded-2xl min-h-[calc(100vh-4rem)] m-2">
            <div className="p-6">
            ...
            <div className="p-4 m-3 rounded-xl bg-white/5">
                <p className="text-xs text-white/60 mb-2">Ai nevoie de ajutor?</p>
                <Link
                    href="#"

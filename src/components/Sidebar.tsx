...
const navItems = [
  ...
  { href: "/dashboard/impact", icon: BarChart3, label: "Impact Report" },
];
...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex w-64 shrink-0 flex-col bg-forest rounded-r-2xl min-h-[calc(100vh-4rem)]">
      <div className="p-6">
        ...
        <p className="text-xs text-white/50">
          Manage your listings and track impact
        </p>
      </div>
      ...
      <div className="p-4 m-3 rounded-xl bg-white/5">
        <p className="text-xs text-white/60 mb-2">Need help?</p>
        <Link
          href="#"

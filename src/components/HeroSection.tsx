                ...
                <div className="mx-auto w-full max-w-2xl text-center relative z-10 pt-16 flex flex-col items-center">
                    ...
                    <div className="mb-6 inline-flex items-center gap-3 py-2 text-xs font-medium text-black-500">
                        ...
                        <span className="flex items-center gap-2 divide-x divide-black-300 text-[11px] sm:text-xs hidden sm:flex">
                            <span className="pl-2 pr-2"><strong><AnimatedCounter end={12450} /></strong> tons salvaged</span>
                            <span className="px-2"><strong><AnimatedCounter end={3.2} prefix="$" suffix="M" decimals={1} /></strong> saved</span>
                            <span className="pl-2"><strong><AnimatedCounter end={4800} suffix="+" /></strong> active sellers</span>
                        </span>
                        <span className="flex sm:hidden items-center gap-2 divide-x divide-black-300 text-[11px]">
                            <span className="pr-1"><strong><AnimatedCounter end={12450} /></strong> tons</span>
                            <span className="px-1"><strong><AnimatedCounter end={3.2} prefix="$" suffix="M" decimals={1} /></strong> saved</span>
                            <span className="pl-1"><strong><AnimatedCounter end={4800} suffix="+" /></strong> sellers</span>
                        </span>
                    </div>
                    ...
                    <p className="text-sm sm:text-base text-black-500 mb-8 max-w-xl mx-auto">
                        The marketplace for surplus construction materials, connecting builders and contractors.
                    </p>
